...
def main() -> int:
    ...
    parser.add_argument("--input-root", type=Path, default=Path("data/local"))
    parser.add_argument("--output-dir", type=Path, default=Path("docs/spikes/cleaning-dataset-audit"))
    parser.add_argument("--cache-dir", type=Path, default=Path("artifacts/dataset-audit"))

...
RUN_BASE = ROOT / "data/local/mvp1-full-page-cleaning-v0.1/slice-3/run-v0.5"
SNAPSHOT = ROOT / "data/local/mvp1-visual-contract-spike-a-v0.1/run-v0.4/visual-contract-snapshot.json"
PIXEL_SNAPSHOT = ROOT / "data/local/mvp1-visual-contract-spike-b-v0.1/run-v0.7/pixel-evidence-snapshot.json"
IMAGE_ROOT = ROOT / "data/local/text-seeded-container-association/goal6-minimal-cleaning-v0.1/full-page-v0.1/images"
...
def _build_targets(case_id: str, page: dict, source: Path, run_dir: Path):
    ...
    for segment in page["text_segments"]:
        ...
        instance_mask = _read_mask(ROOT / "data/local/mvp1-visual-contract-spike-a-v0.1/run-v0.4" / instance["mask_artifact"]["relative_path"])
...
def _spike_b_functions():
    spec = importlib.util.spec_from_file_location("slice3_spike_b", ROOT / "tools/spikes/mvp1_visual_contract/spike_b.py")

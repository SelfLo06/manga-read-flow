...
RUN = ROOT / "data/local/mvp1-single-page-cleaning-correction-v0.1/case-71-g002-s02-run-v0.1"
SOURCE = ROOT / "data/local/text-seeded-container-association/goal6-minimal-cleaning-v0.1/full-page-v0.1/images/case-71.webp"
A = ROOT / "data/local/mvp1-visual-contract-spike-a-v0.1/run-v0.4/masks/case-71"
B = ROOT / "data/local/mvp1-visual-contract-spike-b-v0.1/run-v0.7/artifacts/case-71"
D = ROOT / "data/local/mvp1-visual-contract-spike-d-v0.1/run-v0.5/artifacts/case-71/579e153eb424310a"
OLD = ROOT / "data/local/mvp1-single-page-cleaning-slice-v0.1/case-71-run-v0.3"

...
def _real_cases(
    ...
    from tools.spikes.text_seeded_container_association.goal6_build_calibration import _contexts
    ...
    input_lock = {
        ...
        "visual_contract_sha256": sha256_file(
            repository_root / "docs/design/mvp1-visual-contract/final/mvp1-visual-contract-dd-v0.1.md"
        ),

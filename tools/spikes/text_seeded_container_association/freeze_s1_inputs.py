...
DEFAULT_PACK = (
    ...
    / "data"
    / "local"
    / "text-seeded-container-association"
    / "r0-final-blind-v0.3"
)
DEFAULT_SPEC = DEFAULT_PACK / "S1-INPUT-SPEC.local.json"
DEFAULT_OUTPUT_ROOT = DEFAULT_PACK / "s1-runs"
DEFAULT_DETECTOR_MODULE = ROOT_DIR / "tools" / "spikes" / "detection_ocr" / "spike.py"
DEFAULT_GROUPING_MODULE = ROOT_DIR / "tools" / "spikes" / "text_region_grouping" / "spike.py"

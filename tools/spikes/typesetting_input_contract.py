...
from tools.spikes.detection_ocr.spike import MangaOcrRunner
from tools.spikes.page_translation import spike as translation


ROOT = Path(__file__).resolve().parents[2]
PROMPT_PATH = ROOT / "prompts" / "page-translation" / "system-v1.md"
REPAIR_PROMPT_PATH = ROOT / "prompts" / "page-translation" / "repair-system-v1.md"
SCHEMA_PATH = ROOT / "local_samples" / "page_translation" / "schema.json"

...
FROZEN = ROOT / "data/local/mvp1-full-page-cleaning-v0.1/slice-3/run-v0.5/case-72"
DEFAULT_OUTPUT = ROOT / "data/local/physical-bubble-boundary-spike-v0.1/stage-a-run-v0.2"

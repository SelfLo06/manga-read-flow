...
RUN_ROOT = ROOT / "data/local/reviews/150-cleaning/single-page-slice-v0.1/case-71-run-v0.3"
SOURCE = ROOT / "data/local/reviews/150-cleaning/association-goal6-v0.1/full-page-v0.1/images/case-71.webp"
A_ROOT = ROOT / "data/local/reviews/120-grouping/visual-contract-a-v0.1/run-v0.4"
B_ROOT = ROOT / "data/local/reviews/160-typesetting/visual-contract-b-v0.1/run-v0.7/artifacts/case-71"
D_ROOT = ROOT / "data/local/reviews/150-cleaning/visual-contract-d-v0.1/run-v0.5/artifacts/case-71/579e153eb424310a"

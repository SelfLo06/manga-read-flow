...
def materialize(output_root: Path) -> dict[str, Any]:
    ...
    for asset_id, filename in FULL_PAGE_SOURCES:
        source = ROOT / "data/local/sources/110-detection/real-samples-v0.1" / filename
        ...
        source_records.append(
            {
                "asset_id": asset_id,
                "source_relative_path": f"data/local/sources/110-detection/real-samples-v0.1/{filename}",

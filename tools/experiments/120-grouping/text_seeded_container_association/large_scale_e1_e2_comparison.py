...
from tools.experiments.grouping_120.text_seeded_container_association import freeze_s1_inputs as s1
...
from tools.experiments.grouping_120.text_seeded_container_association.goal6_full_page_trial import (
...
BOOK_SOURCE = ROOT / "data/local/datasets/manga-triplets/(C80) [蒼空市場 (蒼)] 東奔西走ブレイカー (東方Project)/(C80) [蒼空市場 (蒼)] 東奔西走ブレイカー (東方Project)"

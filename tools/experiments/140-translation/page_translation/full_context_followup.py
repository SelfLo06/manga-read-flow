...
FOLLOWUP_ROOT = ROOT_DIR / "data/local/datasets/140-translation/page-translation-v0.1/full_context_followup"
OUTPUT_ROOT = ROOT_DIR / "data/local/reviews/140-translation/full-context-v0.1"
PARENT_SPIKE_PATH = Path(__file__).resolve().with_name("spike.py")
...
PARENT_SCHEMA_PATH = ROOT_DIR / "data/local/datasets/140-translation/page-translation-v0.1/schema.json"

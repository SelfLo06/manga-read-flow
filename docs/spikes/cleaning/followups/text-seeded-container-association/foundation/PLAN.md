...
```text
docs/spikes/cleaning/followups/text-seeded-container-association/foundation/GOAL.md
docs/spikes/cleaning/followups/text-seeded-container-association/foundation/HARNESS.md
docs/spikes/cleaning/followups/text-seeded-container-association/foundation/PLAN.md
docs/spikes/cleaning/followups/text-seeded-container-association/r0/FREEZE.md  # retired v0.2 record
docs/spikes/cleaning/followups/text-seeded-container-association/r0/CANDIDATE-EXPANSION.md
docs/spikes/cleaning/followups/text-seeded-container-association/r0/R0-SELECTION-v0.3.md
docs/spikes/cleaning/followups/text-seeded-container-association/r0/R0-ADJUDICATION-v0.3.md
docs/spikes/cleaning/followups/text-seeded-container-association/goal1-s1-input-freeze/S1-INPUT-FREEZE-v0.1.md
docs/spikes/cleaning/followups/text-seeded-container-association/goal2-harness-calibration/GOAL2-HARNESS-CALIBRATION-v0.1.md
```
...
Goal 3 的结果见 [`../goal3-r0-validation/GOAL3-R0-VALIDATION-REPORT-v0.1.md`](../goal3-r0-validation/GOAL3-R0-VALIDATION-REPORT-v0.1.md) 与 [`../goal3-r0-validation/GOAL3-GATE-v0.1.md`](../goal3-r0-validation/GOAL3-GATE-v0.1.md)。当前不得进入 Pixel Text Mask；继续前需新开 focused association correction Goal。

4. Goal 4 — Focused Association Correction：`COMPLETE`；最终冻结 `B1_STRONG_BASELINE_ONLY`，corrected P1 未被选择，不进入 Pixel Text Mask 或 Cleaning。详见 [`../goal4-focused-correction/GOAL4-FOCUSED-CORRECTION-REPORT-v0.1.md`](../goal4-focused-correction/GOAL4-FOCUSED-CORRECTION-REPORT-v0.1.md) 与 [`../goal4-focused-correction/GOAL4-GATE-v0.1.md`](../goal4-focused-correction/GOAL4-GATE-v0.1.md)。
...
4. 读取 [`../r0/FREEZE.md`](../r0/FREEZE.md) 的 reopening notice 与 [`../r0/CANDIDATE-EXPANSION.md`](../r0/CANDIDATE-EXPANSION.md)，确认没有把历史候选误当 final freeze；
5. 若来源出现未解决冲突，停止。

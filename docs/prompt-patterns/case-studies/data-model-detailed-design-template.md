...
Do not design full API.
Do not modify unrelated files.
Do not edit final design files in proposal round.
Do not edit ADR files in proposal round.
Do not invent features outside SRS/HLD.
If unclear, list as open question.
If SRS and HLD conflict, report conflict.
```
...
```text
You are the orchestrator for <design-area> detailed design.
...
- HLD
- PROJECT-PLAN
- relevant previous detailed designs
- <design-area>/GOAL.md

...
6. [final/migration-staging-amendment-v0.1.1.md](final/migration-staging-amendment-v0.1.1.md)：v3 逻辑版本与两条不可变物理 migration record 的分期修订。
7. [final/open-questions.md](final/open-questions.md)：不阻塞当前实施的开放问题。
...
- [Slice 2——组合、验证与原子验收](../../implementation/mvp1-full-page-cleaning/slices/02-composition-validation-acceptance/README.md)：实施中。
